export const TrailbackLogoMark = ({ size = 32 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 680 680" xmlns="http://www.w3.org/2000/svg">
    ...
    <g transform="translate(340, 340)">
      ...
      <circle cx="-90" cy="0" r="11" fill="#1D9E75" opacity="0.18" />
      <circle cx="-36" cy="0" r="11" fill="#1D9E75" opacity="0.42" />
      <circle cx="18" cy="0" r="11" fill="#1D9E75" opacity="0.7" />
      <circle cx="70" cy="0" r="11" fill="#6ee7b7" />
      <circle cx="70" cy="0" r="24" fill="none" stroke="#6ee7b7" strokeWidth="2.5" opacity="0.4" />
    </g>
  </svg>
)
